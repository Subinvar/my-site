...
export function SiteFooter({ locale, links, contacts, email }: FooterProps) {
  return (
    <footer className="mt-12 border-t border-zinc-200 bg-white">
      <div className="mx-auto grid max-w-5xl gap-6 px-4 py-8 sm:grid-cols-2 sm:px-6">
        <div>
          <h2 className="text-sm font-semibold text-zinc-900">{locale === 'ru' ? 'Навигация' : 'Navigation'}</h2>
        ...
        <div>
          <h2 className="text-sm font-semibold text-zinc-900">{locale === 'ru' ? 'Контакты' : 'Contacts'}</h2>
