  ...
  },
  {
    ...
    body: {
      ru: [
        ...
        'Через Интема Групп российские литейные предприятия получают доступ к европейским технологиям Cavenaghi: системам No-Bake, Cold-Box, Hot-Box, неорганическим связующим и современным покрытиям для стержней и форм.',
      ],
      en: [
