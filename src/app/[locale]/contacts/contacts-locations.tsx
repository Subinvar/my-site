...
export function ContactsLocations({
  ...
  const ctaActionClasses = 'text-[var(--header-border)] hover:text-muted-foreground';
              ...
              <button
                ...
                className={buttonClassNames({
                  ...
                  className: cn(
                    ...
                    'h-auto min-h-[72px] cursor-pointer flex-col items-start justify-start px-3 py-2 text-left',
