import type { ColorScheme } from '@keystar/ui/types';
import type { ReactElement } from 'react';
import type { ComponentSchema, FormField, SlugFormField } from "./form/api.d.ts";
import type { Locale } from "./app/l10n/locales.d.ts";
import type { RepoConfig } from "./app/repo-config.d.ts";
