...
import type { Glob } from "../config.d.ts";
import type { ChildField } from "./fields/child.d.ts";
...
export type { ChildField } from "./fields/child.d.ts";
...
export * as fields from "./fields/index.d.ts";
