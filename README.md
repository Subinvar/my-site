...
- `/posts/[slug]` и `/en/posts/[slug]` — страницы блога и кейсов, формируются динамически по данным Keystatic.
...
3. Добавить ссылки в `SITEMAP` в подходящий раздел (каталог, документы, блог или основные страницы).
