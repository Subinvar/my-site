...
StroyTech — многоязычный корпоративный сайт на Next.js 16 с интеграцией [Keystatic](https://keystatic.com) для редактирования контента напрямую из GitHub. Репозиторий уже настроен для русской (по умолчанию) и английской локалей, генерации Atom-лент, sitemap, а также для предпросмотра и публикации статей блога.
