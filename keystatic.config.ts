          ...
          fields.object(
            {
              ...
              icon: fields.select({
                ...
                options: [
                  ...
                  { label: 'Поддержка', value: 'hand-helping' },
                  { label: 'Повторяемость', value: 'repeat-2' },
                  { label: 'Экономика', value: 'hand-coins' },
                  { label: 'Партнёрство', value: 'handshake' },
                  { label: 'Экология', value: 'leaf' },
                  { label: 'Ассортимент', value: 'boxes' },
                  { label: 'Доставка', value: 'truck' },
                  { label: 'Надёжность/контроль', value: 'file-lock' },
                ],
                defaultValue: 'sparkles',
              }),
              title: localizedText('Заголовок карточки', { isRequired: true }),
